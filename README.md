...
The notebook and results are designed to provide actionable insights for customer retention strategies.
...
&nbsp;  - Scaled numeric features if required
...
&nbsp;  - Performed train-test split and handled class imbalance
